...
[![Microservices](https://img.shields.io/badge/Microservices-000000?style=for-the-badge&logo=kubernetes&logoColor=white)](#tech-stack)
...
Building backend services for an **AI-powered healthcare platform** — high-volume workflows, multi-tenant isolation, and AI service integration.

- Designed RESTful APIs for patient workflow management and seamless AI model integration
- Architected a **multi-tenant** system with secure data isolation across healthcare organizations
- Integrated **MongoDB**, **Oracle**, **Azure**, and **GCP** to improve scalability and reliability
- Tuned backend processing and database queries for performance
- Shipped features in Agile sprints with cross-functional teams

### Backend Java Developer · Mindbridges Technologies
**Dec 2024 – Jun 2025** · Chennai, India

Owned backend services for a **Timesheet Management System** — submissions, approvals, and real-time status.

- Built secure REST APIs with **Spring Security** and **JWT** across **5+ user roles**
- Added **Redis** caching and **WebSocket** notifications — **35%** less redundant database access
- Optimized **MySQL** and **PostgreSQL** queries for reporting and operations
- Contributed to sprint planning, code reviews, and API testing
...
Workflow platform for **AI**, **Coder**, and **Physician** roles with automated task allocation.

- REST APIs for patient workflow, document processing, and AI inference
- Service-to-model communication for coding automation
- MongoDB aggregation pipelines for healthcare analytics and reporting

### Timesheet Management System
**Mindbridges Technologies** · Spring Boot · JWT · Redis · WebSocket

Automated employee timesheet submission and approval — less manual effort, live status instead of page refreshes.

- Role-based auth across 5+ roles
- WebSocket real-time updates
- Query optimization for faster reports
...
*Building secure, high-performance backend systems — one service at a time.*
